...
{% highlight text %}
## Error in .jnew("opennlp.tools.namefind.TokenNameFinderModel", .jcast(.jnew("java.io.FileInputStream", : java.lang.OutOfMemoryError: Java heap space.jnew("opennlp.tools.namefind.TokenNameFinderModel", .jcast(.jnew("java.io.FileInputStream", model), "java.io.InputStream"))new("jobjRef", jobj = <pointer: 0x0000000038c455c0>, jclass = "java/lang/OutOfMemoryError")
{% endhighlight %}
